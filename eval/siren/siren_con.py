...
class SPATIALSIRENBASELINE(nn.Module):
    ...
    def __init__(self, input_dim=2, z_dim=256, hidden_dim=256, output_dim=1, device=None):
        super().__init__()
        self.device = device
    ...
    def forward(self, input, latent, ray_directions, **kwargs):
        frequencies, phase_shifts = self.mapping_network(latent)
