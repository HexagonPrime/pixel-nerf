...
CelebA_4gpus = {
    0: {'batch_size': 12, 'num_steps': 12, 'img_size': 64, 'batch_split': 4, 'gen_lr': 6e-5, 'disc_lr': 2e-4, 'enc_lr': 2e-4},
    int(200e3): {},
...
CelebA_8gpus = {
    0: {'batch_size': 6, 'num_steps': 12, 'img_size': 64, 'batch_split': 2, 'gen_lr': 6e-5, 'disc_lr': 2e-4, 'enc_lr': 2e-4},
    int(200e3): {},
...
CelebA_ganinv = {
    0: {'batch_size': 12, 'num_steps': 12, 'img_size': 64, 'batch_split': 1, 'gen_lr': 6e-5, 'disc_lr': 2e-4, 'enc_lr': 2e-4},
    int(200e3): {},
...
CARLA_prog = {
    0: {'batch_size': 9, 'num_steps': 48, 'img_size': 32, 'batch_split': 3, 'gen_lr': 4e-5, 'disc_lr': 4e-4, 'enc_lr': 4e-5},
    int(50e3): {'batch_size': 3, 'num_steps': 36, 'img_size': 64, 'batch_split': 3, 'gen_lr': 2e-5, 'disc_lr': 2e-4, 'enc_lr': 4e-5},
    int(100e3): {'batch_size': 1, 'num_steps': 36, 'img_size': 64, 'batch_split': 1, 'gen_lr': 10e-6, 'disc_lr': 10e-5, 'enc_lr': 4e-5},
    int(120e3): {'batch_size': 1, 'num_steps': 36, 'img_size': 64, 'batch_split': 1, 'gen_lr': 10e-6, 'disc_lr': 10e-5, 'enc_lr': 2e-5},
    int(200e3): {'batch_size': 1, 'num_steps': 36, 'img_size': 64, 'batch_split': 1, 'gen_lr': 10e-6, 'disc_lr': 10e-5, 'enc_lr': 10e-5},
    int(400e3): {},
...
CARLA_ganinv = {
    0: {'batch_size': 9, 'num_steps': 48, 'img_size': 64, 'batch_split': 1, 'gen_lr': 4e-5, 'disc_lr': 4e-4},
    int(400e3): {},
